			                		...
			                		<div class="col-sm-12">
			                			...
			                			<div class="box-container">
					                		<a href="water-drinking-water-popup" class="hover-overlay blue popup-trigger" id="water-main">
						                		<div class="col-sm-12 box box-2 box-title" style="background-image: url('img/water/access-to-drinking-water-600.jpg');">
		                		...
		                		<div class="col-sm-12">
		                			<div class="box-container">
				                		<a href="water-conservation-popup" class="hover-overlay blue popup-trigger" id="water-main">
					                		<div class="col-sm-12 box-title box box-1" style="background-image: url('img/water/conservation2-600.jpg');">
					                			<div class="inner-title center">REDUCING CLIMATE VULNERABILITIES</div>
					                		</div>
				                		</a>
		                			</div>
		                		</div> <!-- /.col-sm-6 -->
			                			...
			                			<div class="box-container">
					                		<a href="water-ramsar-popup" class="hover-overlay blue popup-trigger" id="water-main">
						                		<div class="col-sm-12 box-title box box-2" style="background-image: url('img/water/ramsar-600.jpg');">
							                		<div class="inner-title">A NEW RAMSAR SITE</div>
							                	</div>
					                		</a>
			                			</div>
		                			</div>		                			
