	            	...
	            	<div class="container-fluid fluid-fixed">
		                ...
		                <div class="box-wrap rm-col-padding">
		                	<div class="col-sm-9">
			                	<div class="col-sm-6 box-g box-g-ui-4" data-swiper-parallax="-300">
			                		<div class="col-sm-12">
			                			...
			                			<div class="box-container">
					                		<a href="climate-change-building-community-popup" class="hover-overlay pink popup-trigger" id="climate-change-main">
		                	...
		                	<div class="col-sm-3 box-g box-g-ui-3" data-swiper-parallax="-100">
		                		<div class="col-sm-12">
		                			<div class="box-container">
				                		<a href="climate-change-permanent-popup" class="hover-overlay pink popup-trigger" id="climate-change-main">
