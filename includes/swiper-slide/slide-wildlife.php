	            ...
	            <div class="swiper-slide slide-wildlife" data-hash="slide-wildlife">
	            	<div class="container-fluid fluid-fixed">
		                <div class="title" data-swiper-parallax="-100">Wildlife</div>
		                <div class="box-wrap rm-col-padding">
		                	<div class="col-sm-9">
			                	<div class="col-sm-6 box-g box-g-ui-4" data-swiper-parallax="-300">
			                		<div class="col-sm-12">
			                			<div class="box-container">
					                		<a href="wildlife-rhino-translocation-popup" class="hover-overlay black popup-trigger" id="wildlife-main">
			                			...
			                			<div class="box-container">
					                		<a href="wildlife-snow-leopard-collaring-popup" class="hover-overlay black popup-trigger" id="wildlife-main">
		                	...
		                	<div class="col-sm-6 box-g box-g-ui-5" data-swiper-parallax="-200">
		                		<div class="col-sm-12">
		                			<div class="box-container">
				                		<a href="wildlife-zero-poaching-popup" class="hover-overlay black popup-trigger" id="wildlife-main">
		                		...
		                		<div class="col-sm-12">
		                			<div class="box-container">
				                		<a href="wildlife-swamp-deer-translocation-popup" class="hover-overlay black popup-trigger" id="wildlife-main">
		                	...
		                	<div class="col-sm-3 box-g box-g-ui-3" data-swiper-parallax="-100">
		                		<div class="col-sm-12">
		                			<div class="box-container">
				                		<a href="wildlife-reducing-human-wildlife-conflict-popup" class="hover-overlay black popup-trigger" id="wildlife-main">
	            ...
	            </div> <!-- wildlife slide .swiper-slide end -->