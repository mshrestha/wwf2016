				<div class="swiper-slide slide-with-video" data-hash="slide-home">
					<div class="welcome-video img-cover" style="background-image: url('img/cover.jpg');">
						<div id="bgndVideo" class="player" data-property="{videoURL:'http://youtu.be/1tWYm9EiwxA',containment:'.welcome-video', autoPlay:false, mute:false, startAt:0, opacity:1, quality: 'medium'}">My video</div>
						<!-- , quality:'hd720' -->
					</div>
