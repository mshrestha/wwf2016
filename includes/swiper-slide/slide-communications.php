	            ...
	            <div class="swiper-slide slide-communications" data-hash="slide-communications">
	            	<div class="container-fluid fluid-fixed">
		                ...
		                <div class="box-wrap rm-col-padding">
			                		...
			                		<div class="col-sm-12">
			                			<div class="box-container">
					                		<a href="communications-prince-harry-popup" class="hover-overlay brown popup-trigger" id="communications-main">
						                		<div class="col-sm-12 box box-2 box-title curve-bg brown-box wwf-nepal-title">
						                			<div class="inner-title">A ROYAL VISIT</div>
				                				</div>
					                		</a>
			                			</div>
			                			<div class="box-container">
					                		<a href="communications-mountain-day-popup" class="hover-overlay brown popup-trigger" id="communications-main">
						                		<div class="col-sm-12 box box-1 box-title curve-bg brown-box wwf-nepal-title" style="background-image: url('img/communications/international-mountain-day1-600.jpg');">
		                	...
		                	<div class="col-sm-6 box-g box-g-ui-5" data-swiper-parallax="-200">
		                		<div class="col-sm-12">		                		
		                			<div class="box-container">
				                		<a href="communications-earth-hour-popup" class="hover-overlay brown popup-trigger" id="forests-main">
		                		...
		                		<div class="col-sm-12">		                			
		                			<div class="box-container left-padding">
				                		<a href="communications-tiger-day-popup" class="hover-overlay orange popup-trigger" id="forests-main">
