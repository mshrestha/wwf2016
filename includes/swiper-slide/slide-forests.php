	            ...
	            <div class="swiper-slide slide-forests" data-hash="slide-forests">
	            	<div class="container-fluid fluid-fixed">
		                <div class="title" data-swiper-parallax="-100">Forests</div>
		                <div class="box-wrap rm-col-padding">
		                	<div class="col-sm-9">
			                	<div class="col-sm-6 box-g box-g-ui-4" data-swiper-parallax="-300">
			                		<div class="col-sm-12">
			                			<div class="box-container">
					                		<a href="#" class="hover-overlay green popup-trigger" id="forests-habitat-management">
			                			...
			                			<div class="box-container">
					                		<a href="#" class="hover-overlay green popup-trigger" id="forests-corridors-management">
		                	...
		                	<div class="col-sm-6 box-g box-g-ui-5" data-swiper-parallax="-200">
		                		<div class="col-sm-12">
		                			<div class="box-container">
				                		<a href="#" class="hover-overlay green popup-trigger" id="forests-corridors-restoration">
		                		...
		                		<div class="col-sm-12">
		                			<div class="col-sm-5">
			                			<div class="box-container">
					                		<a href="#" class="hover-overlay green popup-trigger" id="forests-sustainable-communities">
		                			...
		                			<div class="col-sm-7">
			                			<div class="box-container left-padding">
					                		<a href="#" class="hover-overlay green popup-trigger" id="forests-grazing-control">
						                		<div class="col-sm-12 box-title box box-2" style="background-image: url('img/forests/zero-grazing-600.jpg');">
		                	...
		                	<div class="col-sm-3 box-g box-g-ui-3" data-swiper-parallax="-100">
		                		<div class="col-sm-12">
		                			<div class="box-container">
				                		<a href="#" class="hover-overlay green popup-trigger" id="forests-green-recovery">
