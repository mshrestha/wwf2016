    	...
    	<div id="wildlife-rhino-translocation-popup" class="article-section" style="background-image: url('img/wildlife/rhino-translocation.jpg'); height: 100%; width: 100%;top: 0; left: 0; z-index: 999;">
            <div class="section-intro section-absolute section-right box curve-bg light-green-box content-txt">
