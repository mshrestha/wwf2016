		<img src="img/water/piloting-payments-for-ecosystem-services<?php echo get_small_image();?>.jpg" class="hidden">
    	<div id="water-piloting-payments-popup" class="popup-wrap article-section" style="background-image: url('img/water/piloting-payments-for-ecosystem-services<?php echo get_small_image();?>.jpg'); height: 100%; width: 100%; top: 0; left: 0; z-index: 999;">
    		<?php copyright('Juha-Pekka Kervinen');?>
	        <?php
	        // var_dump($wildlife_section);
	        $popup_water_section_current = 4;

	        popup_navigation($popup_water_section[$popup_water_section_current-1], $popup_water_section[$popup_water_section_first]);
	        ?>
			<div class="section-intro content-txt section-absolute section-bottom box blue-box">
