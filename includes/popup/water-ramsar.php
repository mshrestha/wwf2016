    	...
    	<div id="water-ramsar-popup" class="article-section" style="background-image: url('img/water/ramsar<?php echo get_small_image();?>.jpg'); height: 100%; width: 100%; top: 0; left: 0; z-index: 999;">
			<div class="section-intro content-txt section-absolute">
				<h1 class="uppercase">Ramsar</h1>
