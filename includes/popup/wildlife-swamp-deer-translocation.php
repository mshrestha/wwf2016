    	...
    	<div id="wildlife-swamp-deer-translocation-popup" class="popup-wrap article-section" style="background-image: url('img/wildlife/swamp-deer-translocation<?php echo get_small_image();?>.jpg'); height: 100%; width: 100%;position: fixed;top: 0; left: 0; z-index: 999;">            
	            	...
	            	<div class="col-md-8">
			            <div class="video-sec">
			                <div class="embed-responsive embed-responsive-16by9">
							    <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/gXwjemTw-Ng"></iframe>
							</div>
						</div>
	            	</div>
	            	<div class="col-md-4">
