		<img src="img/communications/global-tiger-day<?php echo get_small_image();?>.jpg" class="hidden">
    	<div id="communications-tiger-day-popup" class="article-section popup-wrap" style="background-image: url('img/communications/global-tiger-day<?php echo get_small_image();?>.jpg'); height: 100%; width: 100%; top: 0; left: 0; z-index: 999;">            
    		<?php copyright('WWF Nepal');?>
	        <?php
	        $popup_communications_section_current = 3;
