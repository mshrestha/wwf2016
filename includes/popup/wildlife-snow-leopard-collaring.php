    	...
    	<div id="wildlife-snow-leopard-collaring-popup" class="popup-wrap " style="background-image: url('img/wildlife/snow-leopard-collaring.jpg'); height: 100%; width: 100%; position: fixed;top: 0; left: 0; z-index: 999;">
            <?php
