        ...
        <img src="img/message/cr-message2.jpg" alt="" class="hidden">
            <?php
            popup_navigation();
            ?>
            <div id="" class="article-section" style="background-image: url('img/message/cr-message2.jpg'); min-height: 100%; width: 100%; top: 0; left: 0; z-index: 999;">
