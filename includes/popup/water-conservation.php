		<img src="img/water/conservation2<?php echo get_small_image();?>.jpg" class="hidden">
    	<div id="water-conservation-popup" class="article-section popup-wrap" style="background-image: url('img/water/conservation2<?php echo get_small_image();?>.jpg'); height: 100%; width: 100%; top: 0; left: 0; z-index: 999;">
	        ...
	        ?>
			<div class="section-intro content-txt section-absolute section-bottom section-right box blue-box">
