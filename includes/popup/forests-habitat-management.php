    	...
    	<div id="forests-habitat-management-popup" class="article-section" style="background-image: url('img/forests/habitat-management-in-protected-areas<?php echo get_small_image();?>.jpg'); height: 100%; width: 100%; top: 0; left: 0; z-index: 999;">
    		<?php copyright('WWF Nepal/Akash Shrestha');?>
					...
					<div class="row">
						...
						<div class="col-sm-6">
						  <div class="widget-box">
						    ...
						    <div class="widget-title">
						      <div><span id="habitatGrasslandNumber" class="numbAni">255</span><span>ha</span></div>
						      <span class="widget-title-text">of grasslands managed</span>
						    </div>
					...
					<div class="row">
						<div class="col-sm-6">
					      <div class="widget-box">
					        ...
					        <div class="widget-title">
					          <div id="habitatWetlandNumber" class="numbAni">9</div>
