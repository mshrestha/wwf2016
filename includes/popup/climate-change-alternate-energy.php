		<img src="img/climate-change/alternate-energy<?php echo get_small_image();?>.jpg" alt="" class="hidden">
    	<div id="climate-change-alternate-energy-popup" class="article-section popup-wrap" style="background-image: url('img/climate-change/alternate-energy<?php echo get_small_image();?>.jpg'); height: 100%; width: 100%;top: 0; left: 0; z-index: 999;">
    		<?php copyright('WWF Nepal');?>
	        <?php
	        // var_dump($wildlife_section);
	        $popup_climate_section_current = 2;
            ...
            <div class="section-intro content-txt section-absolute box pink-box">
                <h1 class="uppercase">ALTERNATE ENERGY PROMOTION</h1>
