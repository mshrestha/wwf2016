    	...
    	<div id="communications-mountain-day-popup" class="popup-wrap " style="background-image: url('img/communications/international-mountain-day1.jpg'); height: 100%; width: 100%; position: fixed;top: 0; left: 0; z-index: 999;">
            <?php
