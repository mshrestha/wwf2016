		<img src="img/policy/sustainable-infrastructure<?php echo get_small_image();?>.jpg" class="hidden">
    	<div id="policy-sustainable-popup" class="article-section popup-wrap" style="background-image: url('img/policy/sustainable-infrastructure<?php echo get_small_image();?>.jpg'); height: 100%; width: 100%;top: 0; left: 0; z-index: 999;">
