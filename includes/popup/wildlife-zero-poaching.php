      <img src="img/wildlife/zero-poaching-image<?php echo get_small_image();?>.jpg" class="hidden">
    	<div id="wildlife-zero-poaching-popup" class="popup-wrap" style="background-image: url('img/wildlife/zero-poaching-image<?php echo get_small_image();?>.jpg'); height: 100%; width: 100%;position: fixed; top: 0; left: 0; z-index: 999;">
        ...
        <div class="infographics section-bottom section-left">
      ...
      <?php
      video_popup('wildlife-zero-poaching', 'gF2wBMGLTA0');
      ?>
      <style>
        #wildlife-zero-poaching-popup .infographics{
          /*position: static;
          margin-top: 30px;*/
        }
      </style>