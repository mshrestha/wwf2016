		<img src="img/forests/green-recovery-and-reconstruction<?php echo get_small_image();?>.jpg" class="hidden">
    	<div id="policy-green-recovery-popup" class="article-section popup-wrap" style="background-image: url('img/forests/green-recovery-and-reconstruction<?php echo get_small_image();?>.jpg'); height: 100%; width: 100%; top: 0; left: 0; z-index: 999;">
    		<?php copyright('WWF Nepal-Hariyo Ban Program/Samir Jung Thapa');?>
	        <?php
	        // var_dump($wildlife_section);
	        $popup_policy_section_current = 1;
            ...
            <div class="section-intro content-txt section-absolute box dark-purple-box">
                ...
                <a href="http://bit.ly/2gtZhIb" target="_blank">Download PDF</a>
            </div>
    	</div>