<img src="img/communications/earth-hour.jpg" alt="" class="hidden">
    	<div id="communications-earth-hour-popup" class="article-section" style="background-image: url('img/communications/earth-hour.jpg'); min-height: 100%; width: 100%; top: 0; left: 0; z-index: 999;">
            	...
            	<div class="col-md-8">
		            <div class="video-sec">
		                <div class="embed-responsive embed-responsive-16by9">
						    <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/iAajh5ix4mA"></iframe>
						</div>
					</div>
            	</div>
            </div>
