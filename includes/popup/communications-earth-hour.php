    	...
    	<div id="communications-earth-hour-popup" class="article-section" style="background-image: url('img/communications/earth-hour.jpg'); height: 100%; width: 100%; top: 0; left: 0; z-index: 999;">
            <div class="section-intro content-txt section-absolute">
                ...
                <br>
                <iframe class="hidden" width="100%" height="315" src="https://www.youtube.com/embed/iAajh5ix4mA" frameborder="0" allowfullscreen></iframe>
            </div>
    	</div>